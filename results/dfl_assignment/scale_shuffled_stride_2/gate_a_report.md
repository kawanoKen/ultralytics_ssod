...
- Mean ambiguous-prediction ratio: 0.3761
- Object-level identity-switch events: 634
- Matched-domain ambiguous-negative predictions: 2603
- Matched-domain identity-switch predictions: 614

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0248,
  p=0.06706
- Mean Q90-Q10 width vs instability: Spearman rho=0.0042,
  p=0.7586
...
- Instability detecting assignment error: AUROC=0.7577, AUPRC=0.4332
- Error rate by instability bin: `{"0.0-0.2": {"n": 63608, "error_rate": 0.10206263363098982}, "0.2-0.4": {"n": 5511, "error_rate": 0.5410996189439303}, "0.4-0.6": {"n": 1104, "error_rate": 0.6367753623188406}, "0.6-0.8": {"n": 107, "error_rate": 0.7757009345794392}, "0.8-1.0": {"n": 3, "error_rate": 1.0}}`
