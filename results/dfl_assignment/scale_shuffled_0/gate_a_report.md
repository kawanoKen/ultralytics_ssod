...
- Object-level identity-switch events: 589
- Matched-domain ambiguous-negative predictions: 2602
- Matched-domain identity-switch predictions: 570

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0323,
  p=0.01707
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0130,
  p=0.3393
...
- Instability detecting assignment error: AUROC=0.7593, AUPRC=0.4339
- Error rate by instability bin: `{"0.0-0.2": {"n": 63687, "error_rate": 0.10214015419159327}, "0.2-0.4": {"n": 5401, "error_rate": 0.5436030364747269}, "0.4-0.6": {"n": 1152, "error_rate": 0.6510416666666666}, "0.6-0.8": {"n": 91, "error_rate": 0.7692307692307693}, "0.8-1.0": {"n": 2, "error_rate": 1.0}}`
