...
- Mean ambiguous-prediction ratio: 0.3774
- Object-level identity-switch events: 608
- Matched-domain ambiguous-negative predictions: 2605
- Matched-domain identity-switch predictions: 581

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0135,
  p=0.3203
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0011,
  p=0.9351
...
- Instability detecting assignment error: AUROC=0.7594, AUPRC=0.4325
- Error rate by instability bin: `{"0.0-0.2": {"n": 63600, "error_rate": 0.1019811320754717}, "0.2-0.4": {"n": 5480, "error_rate": 0.5388686131386862}, "0.4-0.6": {"n": 1155, "error_rate": 0.645021645021645}, "0.6-0.8": {"n": 97, "error_rate": 0.8041237113402062}, "0.8-1.0": {"n": 1, "error_rate": 1.0}}`
