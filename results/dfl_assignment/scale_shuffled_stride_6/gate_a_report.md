...
- Mean ambiguous-prediction ratio: 0.3746
- Object-level identity-switch events: 611
- Matched-domain ambiguous-negative predictions: 2589
- Matched-domain identity-switch predictions: 586

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0253,
  p=0.06197
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0085,
  p=0.5318
...
- Instability detecting assignment error: AUROC=0.7566, AUPRC=0.4280
- Error rate by instability bin: `{"0.0-0.2": {"n": 63619, "error_rate": 0.10199783083669973}, "0.2-0.4": {"n": 5477, "error_rate": 0.5459192988862516}, "0.4-0.6": {"n": 1149, "error_rate": 0.6222802436901653}, "0.6-0.8": {"n": 86, "error_rate": 0.7790697674418605}, "0.8-1.0": {"n": 2, "error_rate": 1.0}}`
