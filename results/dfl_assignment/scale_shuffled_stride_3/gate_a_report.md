...
- Mean ambiguous-prediction ratio: 0.3765
- Object-level identity-switch events: 597
- Matched-domain ambiguous-negative predictions: 2599
- Matched-domain identity-switch predictions: 577

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0164,
  p=0.2272
- Mean Q90-Q10 width vs instability: Spearman rho=0.0048,
  p=0.7246
...
- Instability detecting assignment error: AUROC=0.7572, AUPRC=0.4312
- Error rate by instability bin: `{"0.0-0.2": {"n": 63609, "error_rate": 0.1018880975962521}, "0.2-0.4": {"n": 5478, "error_rate": 0.5401606425702812}, "0.4-0.6": {"n": 1138, "error_rate": 0.6520210896309314}, "0.6-0.8": {"n": 108, "error_rate": 0.75}, "0.8-1.0": {"n": 0, "error_rate": null}}`
