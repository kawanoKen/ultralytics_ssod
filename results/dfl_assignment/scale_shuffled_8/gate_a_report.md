...
- Mean object Jaccard: 0.9178
- Mean object instability: 0.0822
- Mean ambiguous-prediction ratio: 0.3751
- Object-level identity-switch events: 600
- Matched-domain ambiguous-negative predictions: 2581
- Matched-domain identity-switch predictions: 579

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0249,
  p=0.06603
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0013,
  p=0.9241
...
- Instability detecting assignment error: AUROC=0.7588, AUPRC=0.4278
- Error rate by instability bin: `{"0.0-0.2": {"n": 63727, "error_rate": 0.10323724637908578}, "0.2-0.4": {"n": 5346, "error_rate": 0.535727646838758}, "0.4-0.6": {"n": 1163, "error_rate": 0.6423043852106621}, "0.6-0.8": {"n": 95, "error_rate": 0.7473684210526316}, "0.8-1.0": {"n": 2, "error_rate": 1.0}}`
