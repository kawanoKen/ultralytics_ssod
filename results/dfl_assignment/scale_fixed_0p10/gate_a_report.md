...
- Mean object Jaccard: 0.9323
- Mean object instability: 0.0677
- Mean ambiguous-prediction ratio: 0.2744
- Object-level identity-switch events: 404
- Matched-domain ambiguous-negative predictions: 2395
- Matched-domain identity-switch predictions: 391

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=-0.2497,
  p=4.279e-78
- Mean Q90-Q10 width vs instability: Spearman rho=0.1755,
  p=7.709e-39
...
- Instability detecting assignment error: AUROC=0.7633, AUPRC=0.4605
- Error rate by instability bin: `{"0.0-0.2": {"n": 64149, "error_rate": 0.10121747805889414}, "0.2-0.4": {"n": 4572, "error_rate": 0.5914260717410323}, "0.4-0.6": {"n": 1442, "error_rate": 0.651872399445215}, "0.6-0.8": {"n": 164, "error_rate": 0.7317073170731707}, "0.8-1.0": {"n": 6, "error_rate": 1.0}}`
