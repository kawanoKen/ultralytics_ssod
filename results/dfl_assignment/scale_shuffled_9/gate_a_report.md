...
- Mean object Jaccard: 0.9174
- Mean object instability: 0.0826
- Mean ambiguous-prediction ratio: 0.3766
- Object-level identity-switch events: 599
- Matched-domain ambiguous-negative predictions: 2609
- Matched-domain identity-switch predictions: 574

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0284,
  p=0.03648
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0099,
  p=0.4643
...
- Instability detecting assignment error: AUROC=0.7578, AUPRC=0.4288
- Error rate by instability bin: `{"0.0-0.2": {"n": 63653, "error_rate": 0.10236752391874696}, "0.2-0.4": {"n": 5455, "error_rate": 0.5444546287809349}, "0.4-0.6": {"n": 1127, "error_rate": 0.6220053238686779}, "0.6-0.8": {"n": 96, "error_rate": 0.7708333333333334}, "0.8-1.0": {"n": 2, "error_rate": 1.0}}`
