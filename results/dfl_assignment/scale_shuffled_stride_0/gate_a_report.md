...
- Mean object Jaccard: 0.9175
- Mean object instability: 0.0825
- Mean ambiguous-prediction ratio: 0.3753
- Object-level identity-switch events: 595
- Matched-domain ambiguous-negative predictions: 2602
- Matched-domain identity-switch predictions: 567

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0180,
  p=0.1839
- Mean Q90-Q10 width vs instability: Spearman rho=0.0026,
  p=0.846
...
- Instability detecting assignment error: AUROC=0.7581, AUPRC=0.4337
- Error rate by instability bin: `{"0.0-0.2": {"n": 63673, "error_rate": 0.10238248551191242}, "0.2-0.4": {"n": 5387, "error_rate": 0.5362910710970856}, "0.4-0.6": {"n": 1176, "error_rate": 0.6641156462585034}, "0.6-0.8": {"n": 94, "error_rate": 0.7553191489361702}, "0.8-1.0": {"n": 3, "error_rate": 1.0}}`
