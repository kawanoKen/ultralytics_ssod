...
- Mean object Jaccard: 0.9466
- Mean object instability: 0.0534
- Mean ambiguous-prediction ratio: 0.2169
- Object-level identity-switch events: 285
- Matched-domain ambiguous-negative predictions: 2078
- Matched-domain identity-switch predictions: 277

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=-0.2244,
  p=5.294e-63
- Mean Q90-Q10 width vs instability: Spearman rho=0.1415,
  p=1.041e-25
...
- Instability detecting assignment error: AUROC=0.7353, AUPRC=0.4435
- Error rate by instability bin: `{"0.0-0.2": {"n": 65217, "error_rate": 0.10799331462655443}, "0.2-0.4": {"n": 3866, "error_rate": 0.6132953957578893}, "0.4-0.6": {"n": 1153, "error_rate": 0.6678230702515178}, "0.6-0.8": {"n": 96, "error_rate": 0.8125}, "0.8-1.0": {"n": 1, "error_rate": 1.0}}`
