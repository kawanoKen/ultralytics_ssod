...
- Mean object Jaccard: 0.9170
- Mean object instability: 0.0830
- Mean ambiguous-prediction ratio: 0.3770
- Object-level identity-switch events: 626
- Matched-domain ambiguous-negative predictions: 2613
- Matched-domain identity-switch predictions: 606

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0206,
  p=0.1288
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0074,
  p=0.5831
...
- Instability detecting assignment error: AUROC=0.7604, AUPRC=0.4350
- Error rate by instability bin: `{"0.0-0.2": {"n": 63576, "error_rate": 0.1016106706933434}, "0.2-0.4": {"n": 5498, "error_rate": 0.5409239723535831}, "0.4-0.6": {"n": 1159, "error_rate": 0.6505608283002589}, "0.6-0.8": {"n": 98, "error_rate": 0.7448979591836735}, "0.8-1.0": {"n": 2, "error_rate": 1.0}}`
