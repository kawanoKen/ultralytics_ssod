...
- Mean object Jaccard: 0.9173
- Mean object instability: 0.0827
- Mean ambiguous-prediction ratio: 0.3782
- Object-level identity-switch events: 622
- Matched-domain ambiguous-negative predictions: 2622
- Matched-domain identity-switch predictions: 602

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0339,
  p=0.01252
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0154,
  p=0.2553
...
- Instability detecting assignment error: AUROC=0.7618, AUPRC=0.4363
- Error rate by instability bin: `{"0.0-0.2": {"n": 63696, "error_rate": 0.10206292388847023}, "0.2-0.4": {"n": 5387, "error_rate": 0.5450157787265639}, "0.4-0.6": {"n": 1149, "error_rate": 0.6492602262837249}, "0.6-0.8": {"n": 97, "error_rate": 0.7835051546391752}, "0.8-1.0": {"n": 4, "error_rate": 1.0}}`
