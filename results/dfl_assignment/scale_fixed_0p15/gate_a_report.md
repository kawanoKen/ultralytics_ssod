...
- Mean object Jaccard: 0.9011
- Mean object instability: 0.0989
- Mean ambiguous-prediction ratio: 0.4010
- Object-level identity-switch events: 731
- Matched-domain ambiguous-negative predictions: 2857
- Matched-domain identity-switch predictions: 696

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=-0.2651,
  p=4.224e-88
- Mean Q90-Q10 width vs instability: Spearman rho=0.1995,
  p=6.169e-50
...
- Instability detecting assignment error: AUROC=0.7912, AUPRC=0.4643
- Error rate by instability bin: `{"0.0-0.2": {"n": 61972, "error_rate": 0.09055702575356613}, "0.2-0.4": {"n": 6051, "error_rate": 0.5275161130391671}, "0.4-0.6": {"n": 2012, "error_rate": 0.6217693836978131}, "0.6-0.8": {"n": 289, "error_rate": 0.6885813148788927}, "0.8-1.0": {"n": 9, "error_rate": 1.0}}`
