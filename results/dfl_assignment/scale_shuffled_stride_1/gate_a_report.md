...
- Mean object Jaccard: 0.9169
- Mean object instability: 0.0831
- Mean ambiguous-prediction ratio: 0.3781
- Object-level identity-switch events: 621
- Matched-domain ambiguous-negative predictions: 2584
- Matched-domain identity-switch predictions: 595

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0161,
  p=0.2342
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0006,
  p=0.9637
...
- Instability detecting assignment error: AUROC=0.7573, AUPRC=0.4328
- Error rate by instability bin: `{"0.0-0.2": {"n": 63605, "error_rate": 0.10140712208159736}, "0.2-0.4": {"n": 5458, "error_rate": 0.5448882374496152}, "0.4-0.6": {"n": 1177, "error_rate": 0.653355989804588}, "0.6-0.8": {"n": 93, "error_rate": 0.7526881720430108}, "0.8-1.0": {"n": 0, "error_rate": null}}`
