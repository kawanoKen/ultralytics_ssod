...
- Mean ambiguous-prediction ratio: 0.3762
- Object-level identity-switch events: 648
- Matched-domain ambiguous-negative predictions: 2587
- Matched-domain identity-switch predictions: 624

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0228,
  p=0.09217
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0039,
  p=0.7729
...
- Instability detecting assignment error: AUROC=0.7581, AUPRC=0.4312
- Error rate by instability bin: `{"0.0-0.2": {"n": 63566, "error_rate": 0.10162665575936822}, "0.2-0.4": {"n": 5497, "error_rate": 0.5413862106603602}, "0.4-0.6": {"n": 1172, "error_rate": 0.643344709897611}, "0.6-0.8": {"n": 95, "error_rate": 0.7368421052631579}, "0.8-1.0": {"n": 3, "error_rate": 1.0}}`
