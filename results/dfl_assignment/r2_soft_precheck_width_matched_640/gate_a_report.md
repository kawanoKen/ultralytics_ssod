...
- Mean object Jaccard: 0.9166
- Mean object instability: 0.0834
- Mean ambiguous-prediction ratio: 0.3755
- Object-level identity-switch events: 698
- Matched-domain ambiguous-negative predictions: 2672
- Matched-domain identity-switch predictions: 661

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=-0.1041,
  p=1.456e-14
- Mean Q90-Q10 width vs instability: Spearman rho=0.2545,
  p=3.88e-81
...
- Instability detecting assignment error: AUROC=0.7734, AUPRC=0.4553
- Error rate by instability bin: `{"0.0-0.2": {"n": 63524, "error_rate": 0.09919085699892954}, "0.2-0.4": {"n": 5484, "error_rate": 0.5616338439095551}, "0.4-0.6": {"n": 1225, "error_rate": 0.6530612244897959}, "0.6-0.8": {"n": 99, "error_rate": 0.8181818181818182}, "0.8-1.0": {"n": 1, "error_rate": 1.0}}`
