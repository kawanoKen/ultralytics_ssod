...
- Mean ambiguous-prediction ratio: 0.3409
- Object-level identity-switch events: 557
- Matched-domain ambiguous-negative predictions: 2686
- Matched-domain identity-switch predictions: 535

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=-0.2592,
  p=3.619e-84
- Mean Q90-Q10 width vs instability: Spearman rho=0.1933,
  p=6.345e-47
...
- Instability detecting assignment error: AUROC=0.7713, AUPRC=0.4167
- Error rate by instability bin: `{"0.0-0.2": {"n": 62980, "error_rate": 0.0950936805335027}, "0.2-0.4": {"n": 5348, "error_rate": 0.556095736724009}, "0.4-0.6": {"n": 1767, "error_rate": 0.6372382569326542}, "0.6-0.8": {"n": 230, "error_rate": 0.7217391304347827}, "0.8-1.0": {"n": 8, "error_rate": 1.0}}`
