...
- Mean ambiguous-prediction ratio: 0.1584
- Object-level identity-switch events: 177
- Matched-domain ambiguous-negative predictions: 1656
- Matched-domain identity-switch predictions: 170

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=-0.1788,
  p=2.743e-40
- Mean Q90-Q10 width vs instability: Spearman rho=0.1017,
  p=5.472e-14
...
- Instability detecting assignment error: AUROC=0.6961, AUPRC=0.4068
- Error rate by instability bin: `{"0.0-0.2": {"n": 66494, "error_rate": 0.11700303786807832}, "0.2-0.4": {"n": 2973, "error_rate": 0.6330306088126472}, "0.4-0.6": {"n": 816, "error_rate": 0.6887254901960784}, "0.6-0.8": {"n": 49, "error_rate": 0.7755102040816326}, "0.8-1.0": {"n": 1, "error_rate": 1.0}}`
