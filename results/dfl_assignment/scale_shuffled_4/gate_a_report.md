...
- Mean ambiguous-prediction ratio: 0.3773
- Object-level identity-switch events: 598
- Matched-domain ambiguous-negative predictions: 2601
- Matched-domain identity-switch predictions: 575

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0343,
  p=0.01142
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0163,
  p=0.2294
...
- Instability detecting assignment error: AUROC=0.7568, AUPRC=0.4308
- Error rate by instability bin: `{"0.0-0.2": {"n": 63706, "error_rate": 0.1019056289831413}, "0.2-0.4": {"n": 5369, "error_rate": 0.547960514062209}, "0.4-0.6": {"n": 1146, "error_rate": 0.6544502617801047}, "0.6-0.8": {"n": 111, "error_rate": 0.7027027027027027}, "0.8-1.0": {"n": 1, "error_rate": 1.0}}`
