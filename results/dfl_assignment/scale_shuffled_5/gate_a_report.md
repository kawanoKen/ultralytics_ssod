...
- Matched-domain ambiguous-negative predictions: 2563
- Matched-domain identity-switch predictions: 577

## Step 3 — DFL shape relation

- DFL confidence vs instability: Spearman rho=0.0267,
  p=0.04914
- Mean Q90-Q10 width vs instability: Spearman rho=-0.0046,
  p=0.7346
...
- Instability detecting assignment error: AUROC=0.7565, AUPRC=0.4307
- Error rate by instability bin: `{"0.0-0.2": {"n": 63671, "error_rate": 0.10208729248794585}, "0.2-0.4": {"n": 5389, "error_rate": 0.5449990721840787}, "0.4-0.6": {"n": 1171, "error_rate": 0.6362083689154568}, "0.6-0.8": {"n": 101, "error_rate": 0.7920792079207921}, "0.8-1.0": {"n": 1, "error_rate": 1.0}}`
